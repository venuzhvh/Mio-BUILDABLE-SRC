...
import il.dev.mio.api.util.plugs.ReflectionUtil;
...
public class XCarry extends Module
{
    ...
    public void onKeyInput(final InputEvent.KeyInputEvent event) {
        if (Keyboard.getEventKeyState() && !(XCarry.mc.currentScreen instanceof MioClickGui) && this.autoStore.getValue().getKey() == Keyboard.getEventKey()) {
            this.autoDuelOn = !this.autoDuelOn;
            Command.sendMessage("<XCarry> §aAutostoring...");
        }
    }
    ...
    private void closeGui() {
        if (this.guiNeedsClose.compareAndSet(true, false) && !ModuleCore.fullNullCheck()) {
    ...
    {
        GuiInventoryWrapper() {
            super((EntityPlayer)IMinecraftUtil.Util.mc.player);
        }
