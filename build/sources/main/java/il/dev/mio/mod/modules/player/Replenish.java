...
public class Replenish extends Module
{
    ...
    public Replenish() {
        ...
        this.delay = (Setting<Integer>)this.register(new Setting("Delay", 2, 0, 10));
        this.gapStack = (Setting<Integer>)this.register(new Setting("GapStack", 50, 50, 64));
        this.xpStackAt = (Setting<Integer>)this.register(new Setting("XPStack", 50, 50, 64));
