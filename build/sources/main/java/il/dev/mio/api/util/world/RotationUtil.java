...
public class RotationUtil implements IMinecraftUtil
{
    ...
    public static boolean isInFov(final Vec3d vec3d, final Vec3d other) {
        ...
        final float fov = (FovMod.getInstance().customFov.getValue() ? FovMod.getInstance().fov.getValue() : RotationUtil.mc.gameSettings.fovSetting) / 2.0f;
