...
import il.dev.mio.api.util.plugs.WireFrameUtil;
...
public class RenderUtil implements IMinecraftUtil
{
    ...
    public static void drawBlockWireframeBottom(final BlockPos bp, final float width, final int r, final int g, final int b, final int alpha) {
    ...
    public static void drawBlockWireframeBottom2(final BlockPos bp, final float width, final int r, final int g, final int b, final int alpha) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static void drawBlockWireframe(final BlockPos bp, final double height, final float width, final int r, final int g, final int b, final int alpha) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
        ...
        final double y = bp.getY() - mc.getRenderManager().viewerPosY;
        final double z = bp.getZ() - mc.getRenderManager().viewerPosZ;
        final AxisAlignedBB bb = new AxisAlignedBB(x, y, z, x + 1.0, y + 1.0 + height, z + 1.0);
        final Tessellator tessellator = Tessellator.getInstance();
        final BufferBuilder bufferbuilder = tessellator.getBuffer();
    ...
    public static void drawBlockWireframe2(final BlockPos bp, final double height, final float width, final int r, final int g, final int b, final int alpha) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static int setColor(final int colorHex) {
    ...
    public static void drawBorderedRect(float x, float y, float x1, float y1, final int insideC, final int borderC) {
        ...
        RenderMethods.drawVLine(x, y, y1 - 1.0f, borderC);
        RenderMethods.drawVLine(x1 - 1.0f, y, y1, borderC);
    ...
    public static void drawGradientBorderedRect(float x, float y, float x1, float y1, final int insideC) {
        ...
        y1 *= 2.0f;
        GL11.glScalef(0.5f, 0.5f, 0.5f);
        RenderMethods.drawVLine(x, y, y1 - 1.0f, new Color(ColorUtil.toRGBA(5000, 0, 1)).getRGB());
        RenderMethods.drawVLine(x1 - 1.0f, y, y1, new Color(ColorUtil.toRGBA(5000, 1000, 1)).getRGB());
        WireFrameUtil.drawGradientHLine(x, x1 - 1.0f, y, new Color(ColorUtil.toRGBA(5000, 0, 1)).getRGB(), new Color(ColorUtil.toRGBA(5000, 1000, 1)).getRGB());
        WireFrameUtil.drawGradientHLine(x, x1 - 2.0f, y1 - 1.0f, new Color(ColorUtil.toRGBA(5000, 0, 1)).getRGB(), new Color(ColorUtil.toRGBA(5000, 1000, 1)).getRGB());
        drawRect(x + 1.0f, y + 1.0f, x1 - 1.0f, y1 - 1.0f, insideC);
        GL11.glScalef(2.0f, 2.0f, 2.0f);
        RenderMethods.disableGL2D();
    }
    ...
    public static void drawGradientLine(final float x, final float y, final float x1, final float y1, final float thickness, final int color1, final int color2) {
        final float red = (color1 >> 16 & 0xFF) / 255.0f;
        final float green = (color1 >> 8 & 0xFF) / 255.0f;
        final float blue = (color1 & 0xFF) / 255.0f;
        final float alpha = (color1 >> 24 & 0xFF) / 255.0f;
        ...
        bufferbuilder.pos((double)x, (double)y, 0.0).color(red, green, blue, alpha).endVertex();
        bufferbuilder.pos((double)x1, (double)y1, 0.0).color(red, green, blue, alpha).endVertex();
        bufferbuilder.pos((double)x, (double)y, 0.0).color(red2, green2, blue2, alpha2).endVertex();
    ...
    public static void drawHGradientRect(final float left, final float top, final float right, final float bottom, final int startColor, final int endColor) {
        final float f = (startColor >> 24 & 0xFF) / 255.0f;
        final float f2 = (startColor >> 16 & 0xFF) / 255.0f;
        final float f3 = (startColor >> 8 & 0xFF) / 255.0f;
        final float f4 = (startColor & 0xFF) / 255.0f;
        ...
        final BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_COLOR);
        bufferbuilder.pos((double)left, (double)top, 0.0).color(f2, f3, f4, f5).endVertex();
        bufferbuilder.pos((double)left, (double)bottom, 0.0).color(f2, f3, f4, f5).endVertex();
        bufferbuilder.pos((double)right, (double)bottom, 0.0).color(f6, f7, f8, f5).endVertex();
    ...
    public static void drawText(final BlockPos pos, final String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-(Mio.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
        Mio.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawBetterCircle(final float x, final float y, final float radius, final int color) {
        final float alpha = (color >> 24 & 0xFF) / 255.0f;
        final float red = (color >> 16 & 0xFF) / 255.0f;
        final float green = (color >> 8 & 0xFF) / 255.0f;
        final float blue = (color & 0xFF) / 255.0f;
